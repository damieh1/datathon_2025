...
Using ISCA’s **gold-standard antisemitism datasets [[1](https://zenodo.org/records/14448399)], [[2](https://zenodo.org/records/15025646)]**, teams fine-tuned transformer models (e.g., [RoBERTa](https://huggingface.co/cardiffnlp/twitter-roberta-base-offensive), [DeBERTa](https://huggingface.co/microsoft/deberta-v3-base), [HateBERT](https://huggingface.co/GroNLP/hateBERT), [BERTweet](https://huggingface.co/vinai/bertweet-base)). Submissions included performance metrics, confusion matrices, error analyses, and reproducible code (in **[Google Colab](https://colab.research.google.com/)**). Bonus points were awarded for testing on newly collected and annotated unseen data.  
